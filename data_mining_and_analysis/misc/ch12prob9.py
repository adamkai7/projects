...
#np.genfromtxt("Auto.csv", delimiter=",")
#with open("Auto.csv", "r") as f:
#    print(f.read())

#data_a = loadtxt('Auto.csv',skiprows=1, usecols=(0,3), delimiter=',')
#print(data_a)
...
def lin_regression(x_a,y):
    #y_v = X@B
    b_v = linalg.pinv(x_a)@y
    #print(b)
    return b_v
